const CACHE_NAME = "carded-static-v28";
const APP_SHELL_ASSETS = [
  ...
  "./community.js?v=5.0.0",
  "./theme.js?v=5.0.0",
  "./config.js?v=5.0.0",
  "./utils.js?v=5.0.0",
  "./auth-guard.js?v=5.0.0",
  "./components.js?v=5.0.0",
  "./auth.js?v=5.0.0",
  "./db.js?v=5.0.0",
  "./supabase-db.js?v=5.0.0",
  "./sync.js?v=5.0.0",
  "./shortcuts.js?v=5.0.0",
  "./walkthrough.js?v=5.0.0",
  "./app.js?v=5.0.0",
  "./styles.css?v=5.0.0",
